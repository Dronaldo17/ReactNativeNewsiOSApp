...
var SportsNewsList = React.createClass({
    ...
    requestFinish:function(networkData){
      ...
      // console.log(newslist);
       sportNews = sportNews.concat(newslist)
       console.log(sportNews);
      this.setState({
          dataSource : this.state.dataSource.cloneWithRows(sportNews),
          loaded : true,
      });
    },
    fetchData : function() {
      NewAPI.sports_News_Fetch(number,page,this.requestFinish);
    },
    onLoadMore:function(){
